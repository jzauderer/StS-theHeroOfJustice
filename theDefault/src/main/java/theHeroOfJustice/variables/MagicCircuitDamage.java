package theHeroOfJustice.variables;
...
public class MagicCircuitDamage extends DynamicVariable
{   // Custom Dynamic Variables are what you do if you need your card text to display a cool, changing number that the base game doesn't provide.
    ...
    public String key()
    {
        return makeID("MAGIC_CIRCUIT_DAMAGE");
    }
    ...
    {
        return MagicCircuits.magicCircuitAmount.get(AbstractDungeon.player) * card.magicNumber;
    }
